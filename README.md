...
Nesse projeto eu pude criar um carrinho de compras totalmente dinâmico. Aqui eu utilizei a API do Mercado Livre para buscar os produtos à venda.
...
```javascript
  ...
  git clone git@github.com:Humberto-Bonadiman/Project-shopping-cart.git
```
